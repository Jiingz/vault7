...
namespace game
{
	...
	public:
		...
		Function<CallingConvention::Thiscall, int, Offsets::NewIssueOrder, int, int, int, int, int, int, char, char, char> IssueOrder;

		// int HudSpellLogic, int Slot, int always4, int State
		Function<CallingConvention::Thiscall, int, Offsets::NewCastSpell, int, int, int, int> CastSpell;
